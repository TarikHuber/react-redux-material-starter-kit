...
var AppNavDrawerFooter = _wrapComponent('AppNavDrawerFooter')(function (_Component) {
	_inherits(AppNavDrawerFooter, _Component);

	function AppNavDrawerFooter() {
		_classCallCheck(this, AppNavDrawerFooter);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(AppNavDrawerFooter).apply(this, arguments));
	}

	_createClass(AppNavDrawerFooter, [{
		key: 'render',
	...
	return AppNavDrawerFooter;
}(_react2.Component));

exports.default = AppNavDrawerFooter;