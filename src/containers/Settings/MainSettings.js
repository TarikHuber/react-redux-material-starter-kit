            ...
            <Activity title={intl.messages.settings} nav_index='settings'>
                <div>
                    <List>
                        ...
                        <ListItem leftIcon={< Style />} primaryText={intl.messages.theme} secondaryText={intl.messages[appStyle.theme.id]} onClick={() => {
                            setThemeDialogOpen(true)
                        }}/>
                        <ThemeDialog/>
                        <Divider inset={true}/>
                        <ListItem leftIcon={< ActionLanguage />} primaryText={intl.messages.language} secondaryText={intl.messages[currentLanguage.id]} onClick={() => {
